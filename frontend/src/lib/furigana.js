...
export const FURIGANA_MAP = {
    ...
    "作ってあります": "<ruby>作<rt>つく</rt></ruby>etteあります", // wait, "作ってあります" is "つく・って" - let's make it proper: "<ruby>作<rt>つく</rt></ruby>ってあります"
    ...
    "行って": "<ruby>行<rt>い</rt></ruby>て", // let's map both to ensure it works
    ...
    "operator": "operator",
    "言って": "<ruby>言<rt>い</rt></ruby>て",
    "言って": "<ruby>言<rt>い</rt></ruby>tter", // let's map cleanly
    ...
    "重": "<ruby>重<rt>おmo</rt></ruby>", // Let's correct to:
    "重": "<ruby>重<rt>おも</rt></ruby>",
    "速": "<ruby>速<rt>はや</rt></ruby>",
    "正": "<ruby>正<rt>ただ</rt></ruby>",
    "常": "<ruby>常<rt>tsune</rt></ruby>", // Let's correct to:
    ...
    "返": "<ruby>返<rt>kae</rt></ruby>", // Let's correct to:
    ...
    "医": "<ruby>医<rt>i</rt></ruby>", // Let's correct to:
